...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
   ...
   var x= CacheHelper.getData(key: 'selectedTimeList')??[];
   print(x);
            ...
            Expanded(
              child: ElevatedButton(
                  ...
                  onPressed: !_enableCreateOrderBtn
                    ...
                    List oldList = CacheHelper.getData(key: 'selectedTimeList') ?? [];
                    oldList.addAll(selectedTimeList);
                    await CacheHelper.saveData(key: 'selectedTimeList', value: json.encode(oldList));
  ...
  void _selectDate() async {
   ...
   Widget buildSingleCheckBox(CheckBoxState checkbox ) {
    ...
    List oldList = CacheHelper.getData(key: 'selectedTimeList') ?? [];
    bool isSelected = oldList.any((item) =>
    item['name'] == widget.field.name && item['ListData'].contains(checkbox.title));

    Color checkboxTitleColor = isSelected ? Colors.grey : Colors.blue;
    // bool isBooked = isSelected ? true : Colors.blue;
    ...
    return CheckboxListTile(
      ...
      value: isSelected ?true : checkbox.value,
      onChanged: isSelected ?null:  (bool? value) {
      setState(() {
