    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            title: const Text("Thank you for downloading FooTballMatch."),
            content: const Text(
                'this is just a sport venue booking App, so the content in this app uses Data and some features to stadium'),
          );
        });
  }
}
